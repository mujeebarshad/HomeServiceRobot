...
if("TRUE" STREQUAL "TRUE")
  set(add_markers_SOURCE_PREFIX /root/catkin_ws/src/add_markers)
  set(add_markers_DEVEL_PREFIX /root/catkin_ws/devel)
  ...
  set(add_markers_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'add_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/add_markers/${idir}'.  ${_report}")
    endif()
